				...
				<div className="apply-img">
					...
					<div className="apply-desc">
						...
						<div className="desc-wrap">
							[회사소개]
							<br />
							카카오픽코마는 작품과 독자의 연결을 통해 독자에게는 일상의
							즐거움을, 콘텐츠 산업에서는 작품의 가치가 더욱 빛날 수 있는 세상을
							만들고자 합니다. 세계 최대의 일본 만화 시장과 프랑스에서 디지털
							만화, 소설 플랫폼 '픽코마'를 전개하고 있으며, 나아가 작품이 국경을
							초월하여 보다 넓은 세상의 독자들과 만날 수 있는 세계를 꿈꾸고
							있습니다.
							<br />
							<br />
							[조직소개]
							...
							서비스로 신 시장을 개척하여 전 세계 사람들이 만화를 보며
							행복해지는 꿈을 꿉니다. 그래서 함께 고민하고 처음부터 다시
							...
							전액 지원받을 수 있습니다. <br />
							• 매월 식비 지원: 사내식당 점심 지원 및 분기별 30만원 씩 기본
							연봉과 별도로 포인트 형태로 지급해 드립니다.
							<br />
							...
							<br />
							• 가족 상해 보험 지원: 본인, 배우자, 자녀, 본인과 배우자의
							부모까지 보장성 보험료와 실손의료비를 지원해 드립니다.
							<br />
							<br />
							[전형안내]
							<br />
...
{
	/* <ul className="insight-card-container">
							<li>
								<div className="card-img-container">
									<img
										src={process.env.PUBLIC_URL + "/assets/insightFour.webp"}
										alt="인사이트카드이미지"
									/>
								</div>
								<div className="card-description">
									<p>경력직의 그룹면접과 PT면접 대비법</p>
									<span>
										경력직 면접에서는 1:1 또는 1:다(면접관)방식이 가장
										보편적이라고 말씀드린 바 있습니다.
									</span>
								</div>
